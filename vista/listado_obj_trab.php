...
<html lang="en"><head>
    ...
    <title>Trabajador | Listado Objetivos</title>
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
			...
			<li class="sub-menu">
                ...
                <ul class="sub">
                    <li class="active"><a href="../vista/listado_obj_trab.php"><i class="fa fa-angle-double-right"></i> Pendientes</a></li>
            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        <font style="text-transform:capitalize; "><strong>Listado</strong> Objetivos, Metas y Peso % Pendientes</font>
                    ...
                    <div class="adv-table">
					   <?php
									...
									$lis_obj->valores_clase_listado_objetivos($_SESSION["codigo"]);
						?>
					   </div>
				   <hr>
				   <div class="adv-table">
