...
<html lang="en"><head>
    ...
    <title>Administrador | Consulta Departamentos/Resultados</title>
	...
	<!--Morris Chart CSS -->
    <link rel="stylesheet" href="../estilos/js/morris-chart/morris.css">
    <!-- Multi Select -->
		...
		<!-- 	<li class="sub-menu">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    ...
                    <li class="active"><a href="../vista/consulta_admin_resultados.php"><i class="fa fa-angle-double-right"></i> Resultados</a></li>					
                </ul>
            </li>
			<li class="sub-menu">
                <a href="javascript:;">
       ...
       <div class="row">
                ...
                <section class="panel">
                    <header class="panel-heading">
                        <font style="text-transform:capitalize; "><strong>Consulta</strong> Departamentos/Resultados</font>
                    ...
                    <form class="form-horizontal" role="form" action="../modelo/ver_reporte_pdf.php" target="_blank">
                     <div class="row">                     
                            ...
                            <label class="col-lg-2 col-sm-2 control-label">Departamentos</label>
                            <div class="col-lg-4">
                                    <?php
							...
							<div class="col-lg-3">
									<select class='populate' id="estado_eval" name="estado_eval" style='width:100%'  multiple='multiple' data-required="true">
                                            <option value="Sobresaliente">Sobresaliente</option>
                                            <option value="Satisfactoria">Satisfactorio</option>
                                            <option value="Insatisfactoria">Insatisfactorio</option>											
                                    </select>												
                            </div>							
							<div class="col-sm-1">
...
<!--Easy Pie Chart-->
<script src="../estilos/js/easypiechart/jquery.easypiechart.js"></script>
<!--Sparkline Chart-->
<script src="../estilos/js/sparkline/jquery.sparkline.js"></script>
<!--jQuery Flot Chart-->
<script src="../estilos/js/flot-chart/jquery.flot.js"></script>
<script src="../estilos/js/flot-chart/jquery.flot.tooltip.min.js"></script>
<script src="../estilos/js/flot-chart/jquery.flot.resize.js"></script>
<script src="../estilos/js/flot-chart/jquery.flot.pie.resize.js"></script>
<!--Morris Chart-->
<script src="../estilos/js/morris-chart/morris.js"></script>
<script src="../estilos/js/morris-chart/raphael-min.js"></script>
<script src="../estilos/js/morris.init.js"></script>
<!--dynamic table-->
...
<script src="../estilos/js/jquery.confirm.js"></script> 
    <!-- Multi Select--> 
<script src="../estilos/select2-3.5.2/select2.js"></script>
...
<script type="text/javascript">
            $(document).ready(function() {
                $("#boton").click(function(event) {;
					...
					var dos = $('#estado_eval').val();					
					var tres = $('#ano_eval').val();					
					total = uno.filter(function(e){return e});	
					estado = dos.filter(function(e){return e});					
                    $("#capa").load("../vista/ver_consulta_admin_resultado.php",{valor1: total, valor2: estado, valor3: tres}, function(response, status, xhr) {
                          if (status == "error") {
