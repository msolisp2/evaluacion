...
<aside>
    <div id="sidebar" class="nav-collapse">
		...
		<!--	<li class="sub-menu">
            ...
            <li>
                <a  class="active" href="../vista/configuracion.php">
                    <i class="fa fa-cog"></i>
            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        <font style="text-transform:capitalize; "><strong>Configuración</strong></font>
...
<script src="../estilos/js/bootstrap-switch.js"></script>
<script src="../estilos/js/scripts.js"></script>
<script src="../estilos/js/advanced-form.js"></script>
<script src="../estilos/js/toggle-init.js"></script>
...
{		
	 $(".estado_config").change(function() {
		$.ajax({		
		type : 'POST',
		url  : '../controlador/contro_act_configuracion.php',
		data:  "id_config="+$(this).attr('rel')+"&estado_config="+$(this).val(),
...
$(document).ready(function()
{		
	 $(".estado_config").click(function() {
	  var num=this.id;
		$.ajax({		
		type : 'POST',
		url  : '../controlador/contro_act_configuracion.php',
		data:  "id_config="+num+"&from="+$("#from_"+num+"").val()+"&to="+$("#to_"+num+"").val(),
		success :  function(data)
				   {	
					window.location='../vista/configuracion.php'							
				   },
