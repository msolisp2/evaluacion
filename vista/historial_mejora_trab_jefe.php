        ...
        <div class="leftside-navigation">
			...
			<li class="sub-menu">
                ...
                <ul class="sub">
					...
					<li  class="active"><a href="../vista/historial_mejora_trab_jefe.php"><i class="fa fa-angle-double-right"></i> Historial</a></li>
                </ul>
            </li>		
                ...
                <section class="panel">
                    ...
                    <div class="adv-table">
					   <?php
									...
									$lis_obj->valores_clase_historial_mejora_jefe($_SESSION["codigo"]);
						?>
					   </div>
				   <hr>
				   <div class="adv-table">
