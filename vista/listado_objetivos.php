...
<html lang="en"><head>
    ...
    <title>Jefe | Listado Objetivos</title>
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
			...
			<li class="sub-menu">
                ...
                <ul class="sub">
					<li class="active"><a href="../vista/listado_objetivos.php"><i class="fa fa-angle-double-right"></i> Pendientes</a></li>
    ...
    <section id="main-content">
            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        <font style="text-transform:capitalize; "><strong>Listado</strong> Objetivos, Metas y Peso %</font>
                    ...
                    <div class="adv-table">
					   <?php
									...
									$lis_obj->valores_clase_listado_objetivos_jefe($_SESSION["codigo"]);
						?>			   
					   </div>
       ...
       <div class="modal-dialog">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">Aprobar Evaluación  Objetivos</h4>
        </div>
       ...
       <div id="aprobar_info_seg" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
       <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title">Aprobar Evaluación  Objetivos Seguimiento</h4>
        </div>
        <div class="modal-body">
        <div id="modalContent_seg" style="display:none;">
...
{   
    ...
    $.ajax({
        cache: false,
        type: 'POST',
        url: '../vista/ver_evaluacion_objetivo_jefe_aprobar.php',
        data: 'id_cod_obj='+essay_id+'&num_seg='+essay_rel,
...
{   var essay_rel = $(this).attr('rel');
    ...
    $.ajax({
        ...
        success: function(data) 
        {
            $('#aprobar_info_seg').show();
            $('#modalContent_seg').show().html(data);
        }
    });
});
</script>
<script type="text/javascript">
   $(document).ready(function() {
                $(".ver").click(function(event) {
                    ...
                    $("#capa").load("../vista/realizar_evaluacion_objetivo_jefe.php",{id_cod_obj: primera }, function(response, status, xhr) {
                          if (status == "error") {
