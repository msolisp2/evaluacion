...
<html lang="en"><head>
    ...
    <title>Administrador | Consulta Departamentos</title>
		...
		<!-- 	<li class="sub-menu">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    ...
                    <li class="active"><a href="../vista/consulta_admin.php"><i class="fa fa-angle-double-right"></i> Departamentos</a></li>
...
<script type="text/javascript">
            $(document).ready(function() {
                $("#boton").click(function(event) {;
                    ...
                    $("#capa").load("../vista/ver_consulta_admin.php",{valor1: total, valor2: dos}, function(response, status, xhr) {
                          if (status == "error") {
