...
<div id="content_objetivo" style="display: none;">
				<table class="table table-bordered">
                                <tr>
                                    ...
                                    <td><strong>CÓDIGO:</strong> FO-TH/AL-027</td>
                                </tr>
                                <tr>
								...
								<tr>
                                    <td colspan="4" align="justify"><strong>Referencia:</strong> Formato <strong>B-3 - Evaluación de Competencias del nivel Ejecutivo</strong></td>
                                </tr>
								<tr>
                                    <td colspan="4" align="justify"><strong>Objetivo:</strong>evaluar las competencias laborales de los empleados que se encuentren en el nivel Ejecutivo.</td>
                                </tr>
								<tr>
				...
				<table class="table table-bordered">
						...
						<table class="table table-bordered">			
								...
								<tr>
									...
									con base en el plan estratégico de la Universidad de Cartagena, reconoce necesidades e impulsa proyectos novedosos que apunten al desarrollo de la institución, identificando la oportunidad y la pertinencia de los mismos.
								...
								<tr>
									...
									propicia el desarrollo de ventajas competitivas y de nuevas fortalezas institucionales.
								...
								<tr>
									<td width="45%" align="justify"><strong>ORIENTACIÓN A RESULTADOS:</strong>
									dirige o encamina sus acciones a lograr los resultados esperados, administra los recursos disponibles y cumple los compromisos adquiridos.
								...
								<tr>
									<td width="45%" align="justify"><strong>NEGOCIACIÓN Y SOLUCIÓN DE CONFLICTOS:</strong>
									capacidad para dirigir o controlar una discusión utilizando técnicas de planificación alternativa para negociar los mejores acuerdos. Se centra en el problema más no en la persona.
								...
								<tr>
									<td width="45%" align="justify"><strong>DESARROLLO DE PERSONAS:</strong>
									conoce las opciones de desarrollo de la administración del personal y contribuye al planeamiento a largo plazo, ayuda a revaluar los objetivos del personal, reconoce la necesidad de ser un modelo a seguir y se comporta como tal.
								...
								<tr>
									<td width="45%" align="justify"><strong>TOMA DE DESICIONES:</strong>
									capacidad y destreza para definir y aplicar entre varias opciones la más conveniente en la solución de problemas.
