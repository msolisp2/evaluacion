...
<div id="content_objetivo" style="display: none;">
 ...
 <br>
 		<form name="correo" id="correo" action="../controlador/contro_crea_respuesta_admin.php" method="post" data-validate="parsley">
		<input type="hidden" id="id_recurso" name="id_recurso" value="<?php echo $recur->id_recurso; ?>">
		<input type="hidden" id="id_usuario" name="id_usuario" value="<?php echo $_SESSION["codigo"] ?>">
							<table class="table table-bordered">
								<tr>
								...
								<tr>
                                    <td colspan="4" align="center">		
										<div class="compose-editor">
											<textarea class="form-control" rows="9"><?php echo $recur->recurso; ?></textarea>	
										</div>
									</td>
                                </tr>
								<tr>
                                    <td colspan="4" align="center"><strong>Respuesta</strong></td>
                                </tr>
								<tr>
                                    <td colspan="4" align="center">		
										<div class="compose-editor">
											<textarea class="wysihtml5 form-control" id="respuesta" name="respuesta" rows="9" data-required="true"></textarea>	
										</div>
									</td>
                                </tr>							
							</table>
