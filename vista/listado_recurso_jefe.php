...
<html lang="en"><head>
    ...
    <title>Jefe | Listado Recursos</title>
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
			...
			<li class="sub-menu">
                ...
                <ul class="sub">
				     <li class="active"><a href="../vista/listado_recurso_jefe.php"><i class="fa fa-angle-double-right"></i> Pendientes</a></li>
                ...
                <section class="panel">
                    ...
                    <div class="adv-table">
					   <?php
									...
									$lis_rec->valores_clase_listado_recursos_jefe($_SESSION["codigo"],$estado,$dia);
						?>
					   </div>
					   <br><br><br><br>
				   <hr><br>
...
{   
    ...
    $.ajax({
        cache: false,
        type: 'POST',
        url: '../vista/ver_total_evaluacion_recurso_jefe.php',
