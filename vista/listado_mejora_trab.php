...
<html lang="en"><head>
    ...
    <title>Empleado | Listado Plan de Mejora</title>
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
			...
			<li class="sub-menu">
                ...
                <ul class="sub">
                    <li class="active"><a href="../vista/listado_mejora_trab.php"><i class="fa fa-angle-double-right"></i> Pendientes</a></li>			
                ...
                <section class="panel">
                    ...
                    <div class="adv-table">
					   <?php
									...
									$lis_obj->valores_clase_listado_mejora($_SESSION["codigo"]);
						?>
					   </div>
				   <hr>
				   <div class="adv-table">
...
<script type="text/javascript">
   $(document).ready(function() {
                $(".re_mej").click(function(event) {
                    ...
                    $("#capa").load("../vista/ver_evaluacion_mejora.php",{id_cod_obj: primera }, function(response, status, xhr) {
                          if (status == "error") {
