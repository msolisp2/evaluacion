...
<html lang="en"><head>
    ...
    <title>Jefe | Historial Recursos</title>
        ...
        <div class="leftside-navigation">
			...
			<li class="sub-menu">
                ...
                <ul class="sub">
                    ...
                    <li class="active"><a href="../vista/historial_recurso_jefe.php"><i class="fa fa-angle-double-right"></i> Historial</a></li>
                </ul>
            </li>	
			<li class="sub-menu">
                <a href="javascript:;">
            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        <font style="text-transform:capitalize; "><strong>Historial</strong> Recursos</font>
                    ...
                    <div class="adv-table">
					   <?php		
									...
									$lis_rec->valores_clase_historial_recursos_jefe($_SESSION["codigo"],$estado);
						?>
					   </div>
					   <br><br><br><br>
				   <hr><br>
...
{   
    ...
    $.ajax({
        cache: false,
        type: 'POST',
        url: '../vista/ver_total_evaluacion_recurso.php',
