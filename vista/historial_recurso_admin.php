...
<html lang="en"><head>
    ...
    <title>Administrador | Historial Recursos</title>
		...
		<!--	<li class="sub-menu">
			...
			<li class="sub-menu">
                ...
                <ul class="sub">
					 ...
					 <li class="active"><a href="../vista/historial_recurso_admin.php"><i class="fa fa-angle-double-right"></i> Historial</a></li>
                </ul>
            </li>			
            <li>
                ...
                <section class="panel">
                    ...
                    <div class="adv-table">
					   <?php		
									...
									$lis_rec->valores_clase_historial_recursos_admin($estado);
						?>
					   </div>
					   <br><br><br><br>
				   <hr><br>
