    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
			...
			<li class="sub-menu">
                ...
                <ul class="sub">
				     <li  class="active"><a href="../vista/listado_eval_trab_jefe.php"><i class="fa fa-angle-double-right"></i>Pendientes</a></li>
            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        <font style="text-transform:capitalize; "><strong>Evaluaciones</strong> Registro, Edición y Eliminación de Evaluaciones</font>
                    ...
                    <div class="adv-table">
					   <?php
									...
									$lis_obj->valores_clase_listado_evaluaciones($_SESSION["codigo"]);
						?>
					   </div>					   
					   <br><br><br><br>
				   <hr><br>
...
<script type="text/javascript">
   $(document).ready(function() {
                $(".cue_eva").click(function(event) {
					var primera = $(this).attr('id');
                    $("#capa").load("../vista/ver_evaluacion_jefe_cualitativa.php",{cod_eva: primera }, function(response, status, xhr) {
                          if (status == "error") {
                            var msg = "Error!, algo ha sucedido: ";
                            $("#capa").html(msg + xhr.status + " " + xhr.statusText);
                          }
