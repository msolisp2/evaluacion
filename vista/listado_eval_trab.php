...
<html lang="en"><head>
    ...
    <title>Empleado | Evaluaciones Trabajadores</title>
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
			...
			<li class="sub-menu">
                ...
                <ul class="sub">
                    <li class="active"><a href="../vista/listado_eval_trab.php"><i class="fa fa-angle-double-right"></i> Pendientes</a></li>
            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        <font style="text-transform:capitalize; "><strong>Listado</strong> Pendientes</font>
                    ...
                    <div class="adv-table">
					   <?php
									...
									$lis_obj->valores_clase_listado_eva_trab($_SESSION["codigo"]);
						?>
					   </div>
				   ...
				   <hr><br>
				   <div class="adv-table">
				  <!-- <form id="form_eval" class="form-horizontal" action="../controlador/contro_act_evaluacion.php" method="post" data-validate="parsley">
							--><div id="capa">
							</div>		                                    
					<!--</form>-->	
					</div> 
