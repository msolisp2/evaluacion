...
<html lang="en"><head>
    ...
    <title>Empleado | Historial Evaluaciones Empleados</title>
        ...
        <div class="leftside-navigation">
			...
			<li class="sub-menu">
                ...
                <ul class="sub">
					...
					<ul class="sub">
                    <li class="active"><a href="../vista/historial_eval_trab.php">&nbsp;&nbsp;&nbsp;<i class="fa fa-angle-right"></i> Realizadas</a></li>
            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        <font style="text-transform:capitalize; "><strong>Historial</strong> Realizadas</font>
                    ...
                    <div class="adv-table">
					   <?php
									...
									$lis_obj->valores_clase_historial_eva_trab($_SESSION["codigo"]);
						?>
					</div>					   
					   <br><br><br><br>
				   <hr><br>
