...
<html lang="en"><head>
    ...
    <title>Jefe | Historial Objetivos</title>
        ...
        <div class="leftside-navigation">
			...
			<li class="sub-menu">
                ...
                <ul class="sub">
					...
					<li class="active"><a href="../vista/historial_objetivos_jefe.php"><i class="fa fa-angle-double-right"></i> Historial</a></li>
                </ul>
            </li>
			<li class="sub-menu">
                <a href="javascript:;">
            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        <font style="text-transform:capitalize; "><strong>Historial</strong> Objetivos, Metas y Peso %</font>
                    ...
                    <div class="adv-table">
					   <?php
									...
									$lis_obj->valores_clase_historial_objetivos_jefe($_SESSION["codigo"]);
						?>			   
					   </div>
               ...
               <div class="prog-row">
                ...
                <div class="side-mini-graph">
                    <div class="target-sell">
                     ...
                     <div class="thumb">
                    <a href="http://www.sistemas.unicartagena.edu.co/" target="_blank"><img src="http://sistemas.unicartagena.edu.co/images/LOGOOFICIALUDEC20.png" alt="" width="45" height="45"></a>
                </div>
                </div>
            </div>
        </li>
...
<li class="widget-collapsible">
    <a href="#" class="head widget-head terques-bg active clearfix">
        <span class="pull-left">Desarrollador</span>
        <span class="pull-right widget-collapse"><i class="ico-minus"></i></span>
    </a>
    <ul class="widget-container">
        <li>
...
<script type="text/javascript">
   $(document).ready(function() {
                $(".ver").click(function(event) {
                    ...
                    $("#capa").load("../vista/ver_evaluacion_objetivo_jefe.php",{id_cod_obj: primera }, function(response, status, xhr) {
                          if (status == "error") {
