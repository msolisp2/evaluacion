...
<html lang="en"><head>
    ...
    <title>Empleado | Historial Objetivos</title>
        ...
        <div class="leftside-navigation">
			...
			<li class="sub-menu">
                ...
                <ul class="sub">
					...
					<li class="active"><a href="../vista/historial_obj_trab.php"><i class="fa fa-angle-double-right"></i> Historial</a></li>
                </ul>
            </li>			
			<li class="sub-menu">
                <a href="javascript:;">
                ...
                <section class="panel">
                    ...
                    <div class="adv-table">
					   <?php
									...
									$lis_obj->valores_clase_historial_objetivos($_SESSION["codigo"]);
						?>
...
function eli_localidad(id){
		 var num=id;
	$.confirm({
	title:"Confirmacion de Eliminación",	
    text: "Seguro desea eliminar esta localidad?",
    confirm: function(button) {
     window.location = "../controlador/contro_eli_localidad.php?id_eli_loc=" + num;
    },
