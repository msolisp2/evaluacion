...
<div id="content_objetivo" style="display: none;">
				<table class="table table-bordered">
                                <tr>
                                    ...
                                    <td><strong>CÓDIGO:</strong> FO-TH/AL-028</td>
                                </tr>
                                <tr>
								...
								<tr>
                                    <td colspan="4" align="justify"><strong>Referencia:</strong> Formato <strong>B-4 - Evaluación de Competencias del nivel Profesional</strong></td>
                                </tr>
								<tr>
                                    <td colspan="4" align="justify"><strong>Objetivo:</strong>evaluar las competencias laborales de los empleados que se encuentren en el nivel Profesional.</td>
                                </tr>
								<tr>
				...
				<table class="table table-bordered">
								<tr>
									...
									posee una proyección social, con el fin de llevar a cabo métodos o actividades que sirvan para el desarrollo del entorno, con el fin de ofrecer buenos servicios.
								...
								<tr>
									...
									consigue mejoras en un corto plazo, realizando actividades con resultados visibles que aporten al desarrollo de la organización y al equipo de trabajo.
								...
								<tr>
									...
									participa activamente en grupos y proyectos que propician la investigación. Desde su experiencia profesional promueve acciones que aportan para la consecución de objetivos del área. Publica textos y artículos que son resultados de experiencias de investigación.
								...
								<tr>
									...
									mantiene expectativas positivas, solicita opiniones, crea buen clima dentro del grupo con actitudes proactivas; mantiene una disposición abierta para aprender y solicita opiniones e ideas de los demás a la hora de tomar decisiones.
