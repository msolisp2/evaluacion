...
<html lang="en"><head>
    ...
    <title>Jefe | Evaluaciones Trabajadores</title>
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
			...
			<li class="sub-menu">
                ...
                <ul class="sub">
					<li><a href="../vista/listado_objetivos.php"><i class="fa fa-angle-double-right"></i> Listado</a></li>
			...
			<li class="sub-menu">
                ...
                <ul class="sub">
				    <li><a href="../vista/registro_evaluaciones.php"><i class="fa fa-angle-double-right"></i> Generar</a></li>
                    <li class="active"><a href="../vista/listado_eval_trab_jefe.php"><i class="fa fa-angle-double-right"></i> Listado</a></li>
			...
			<li class="sub-menu">
                ...
                <ul class="sub">
				     <li><a href="../vista/listado_recurso_jefe.php"><i class="fa fa-angle-double-right"></i> Listado</a></li>
            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        <font style="text-transform:capitalize; "><strong>Listado</strong> Evaluaciones Pendientes</font>
                    ...
                    <div class="adv-table">
					   <?php
									...
									$lis_obj->valores_clase_listado_eva_trab_jefe($_SESSION["codigo"]);
						?>
					   </div>
				   ...
				   <hr><br>
				   <div class="adv-table">
				   <form id="form_eval" class="form-horizontal" action="../controlador/contro_act_evaluacion_jefe.php" method="post" data-validate="parsley">
							<div id="capa"></div>
							</form>	
						 </div> 
                   </div>
...
<script type="text/javascript">
   $(document).ready(function() {
                $(".re_eva").click(function(event) {
					var primera = $(this).attr('id');
					var segunda = $(this).attr('rel');
                    $("#capa").load("../vista/realizar_evaluacion_tipo_"+ segunda +".php",{cod_eva: primera }, function(response, status, xhr) {
                          if (status == "error") {
