...
(function ($, undefined) {
    ...
    $.fn.select2.defaults = {
        ...
        formatNoMatches: function () { return "Ningun resultado"; },
        formatInputTooShort: function (input, min) { var n = min - input.length; return "Por favor ingresa " + n + " o mas caracteres" + (n == 1? "" : "s"); },
        formatInputTooLong: function (input, max) { var n = input.length - max; return "Por favor eliminar " + n + " caracteres" + (n == 1? "" : "s"); },
        formatSelectionTooBig: function (limit) { return "Solo puede seleccionar " + limit + " opcione" + (limit == 1 ? "" : "s"); },
        formatLoadMore: function (pageNumber) { return "Buscando mas resultados…"; },
