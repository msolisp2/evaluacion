...
session_start();
	if($_SESSION["tipo"]=="1") 
	{
$id_dependencias=$_REQUEST["valor1"];
$dependencias = substr($id_dependencias, 0, -1);
	require("../controlador/contro_clase_evaluacion.php");
	$cor=new clase_evaluacion();
	$cor->consulta_evaluacion_correos_admin($dependencias);
  ?> 
                       <h4 class="gen-case"> Redacción del Correo</h4>
                        <div class="compose-mail">
                            <form role="form-horizontal" method="post" action="../controlador/contro_envio_correo_admin.php">
							<input type="hidden" id="correos" name="correos" class="form-control" value="<?php echo $cor->correos ?>">
                                ...
                                <div class="compose-editor">
									...
									<h2>Cordial Saludo</h2>
										Actualmente trabajadores a su cargo tienen pendiente evaluaciones en nuestro sistema.</p>
										<ul>
										  <li>Solicitar a estos, el ingreso al sistema y realización de las actividades pendientes, gracias.</li>
										</ul>
										<br>
