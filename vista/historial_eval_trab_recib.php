...
<html lang="en"><head>
    ...
    <title>Empleados | Historial Evaluaciones Empleados</title>
        ...
        <div class="leftside-navigation">
			...
			<li class="sub-menu">
                ...
                <ul class="sub">
					...
					<li class="active"><a href="../vista/historial_eval_trab_recib.php">&nbsp;&nbsp;&nbsp;<i class="fa fa-angle-right"></i> Recibidas</a></li>
					</ul>
				</li>
				</ul>
			</li>
                ...
                <section class="panel">
                    ...
                    <div class="adv-table">
				   		<?php
									...
									$lis_obj->valores_clase_historial_eva_trab_recib($_SESSION["codigo"]);
						?>
					</div>					   
					   <br><br><br><br>
				   <hr><br>
