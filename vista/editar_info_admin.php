...
<head>
    ...
    <title>Administrador | Editar Perfil</title>
    ...
    <ul class="nav top-menu">
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="../estilos/images/avatar-mini.jpg"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="../estilos/images/avatar-mini-2.jpg"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="../estilos/images/avatar-mini-3.jpg"></span>
                                <span class="subject">
...
$(document).ready(function() {
		...
		success :  function(data)
				   {	
				window.location='../vista/editar_info_admin.php'							
				   },
			  error: function(){
				alert('error!');
			  }
