...
<aside>
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            ...
            <li>
                <a class="active" href="../vista/trabajador.php">
            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        <font style="text-transform:capitalize; "><strong>Cronograma</strong></font>
                    ...
                    <div class="panel-body">
					   ...
					   <?php
						...
						<h4>Descargue aquí el instructivo como <a href="../archivos/MANUAL _EMPLEADO.pdf" download="Manual_Empleado">EMPLEADO</a> o <a href="../archivos/MANUAL_JEFE.pdf" download="Manual_Jefe">JEFE</a></h4>
						<h4>Para realizar un ticket de soporte de ayuda pulse aquí: <a href="http://sistemas.unicartagena.edu.co/soporte/osticket/" target="popup">SOPORTE DE AYUDA</a></h4>
					   </div>
                   </div>
                </section>
            </div>
