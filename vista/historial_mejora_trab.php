...
<html lang="en"><head>
    ...
    <title>Empleado | Historial Plan de Mejora</title>
        ...
        <div class="leftside-navigation">
			...
			<li class="sub-menu">
                ...
                <ul class="sub">
					...
					<li class="active"><a href="../vista/historial_mejora_trab.php"><i class="fa fa-angle-double-right"></i> Historial</a></li>
                </ul>
            </li>			
            <li>
            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        <font style="text-transform:capitalize; "><strong>Historial</strong> Plan de Mejora</font>
                    ...
                    <div class="adv-table">
					   <?php
									...
									$lis_obj->valores_clase_historial_mejora($_SESSION["codigo"]);
						?>
					   </div>
				   <hr>
				   <div class="adv-table">
...
<script type="text/javascript">
   $(document).ready(function() {
                $(".ver_mej").click(function(event) {
					var primera = $(this).attr('id');
                    $("#capa").load("../vista/ver_evaluacion_mejora_resuelta.php",{id_cod_obj: primera }, function(response, status, xhr) {
                          if (status == "error") {
